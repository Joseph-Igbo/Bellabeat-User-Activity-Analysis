...
## Purpose
The processed dataset is generated from the original raw datasets (sourced from [Kaggle Fitbit Activity Data](https://www.kaggle.com/datasets)) using the SQL cleaning script (`sql/data_cleaning.sql`).  
